var data = [
		"kick=test1",
		"kick=test2",
		]; //replace with all the nicks you want to kick in here
var allianceURL = "http//blocgame.com/alliancestats.php?allianceid=2045"; //replace with your alliance URL here
